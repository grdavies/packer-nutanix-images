// centos/ntnx-centos-7.9-basic.pkrvars.hcl
// Variable file for building a CentOS 7.9 image with standard partitions
// To build run `packer build -var-file=ntntnx-centos-7.9-lvm.pkrvars.hcl centos.pkr.hcl`
